...
public class UserController extends BaseController<User> {
    ...
    public Object list(HttpServletRequest request, UserDTO usersDTO) {
    ...
    @PostMapping(name = "创建")
    public Object create(@RequestBody UserDTO usersDTO, HttpServletRequest request) {
        log.info("add users DTO:{}", usersDTO);
        User sourceUsers = new User();
        try {
            User users = BeanUtil.copyProperties(usersDTO, sourceUsers);
    ...
    public Object update(@PathVariable("id") Long id, @RequestBody UserDTO usersDTO, HttpServletRequest request) {
