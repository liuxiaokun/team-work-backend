...
@Slf4j
@Api("角色分配关联表 ")
public class RolePermissionsController extends BaseController<RolePermissions> {
    ...
    public Object list(HttpServletRequest request, RolePermissionsDTO rolePermissionsDTO) {
    ...
    public Object view(@PathVariable("id") Long id) {
        ...
        RolePermissionsDTO rolePermissionsDTO = rolePermissionsService.findRolePermissionsById(id);
        return RO.success(rolePermissionsDTO);
    }

    @ApiOperation(value = "新增RolePermissions", notes = "新增一条RolePermissions记录")
    @PostMapping(name = "创建")
    public Object create(@RequestBody RolePermissionsDTO rolePermissionsDTO, HttpServletRequest request) {
        log.info("add rolePermissions DTO:{}", rolePermissionsDTO);
        RolePermissions sourceRolePermissions = new RolePermissions();
        try {
            RolePermissions rolePermissions = BeanUtil.copyProperties(rolePermissionsDTO, sourceRolePermissions);
    ...
    public Object update(@PathVariable("id") Long id, @RequestBody RolePermissionsDTO rolePermissionsDTO, HttpServletRequest request) {
