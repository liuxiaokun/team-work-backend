...
public class RolesController extends BaseController<Roles> {
    ...
    public Object list(HttpServletRequest request, RolesDTO rolesDTO) {
    ...
    @PostMapping(name = "创建")
    public Object create(@RequestBody RolesDTO rolesDTO, HttpServletRequest request) {
        log.info("add roles DTO:{}", rolesDTO);
        Roles sourceRoles = new Roles();
        try {
            Roles roles = BeanUtil.copyProperties(rolesDTO, sourceRoles);
    ...
    public Object update(@PathVariable("id") Long id, @RequestBody RolesDTO rolesDTO, HttpServletRequest request) {
