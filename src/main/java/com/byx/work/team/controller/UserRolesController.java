...
@Slf4j
@Api("用户角色表")
public class UserRolesController extends BaseController<UserRoles> {
    ...
    public Object list(HttpServletRequest request, UserRolesDTO userRolesDTO) {
    ...
    public Object view(@PathVariable("id") Long id) {
        ...
        UserRolesDTO userRolesDTO = userRolesService.findUserRolesById(id);
        return RO.success(userRolesDTO);
    }

    @ApiOperation(value = "新增UserRoles", notes = "新增一条UserRoles记录")
    @PostMapping(name = "创建")
    public Object create(@RequestBody UserRolesDTO userRolesDTO, HttpServletRequest request) {
        log.info("add userRoles DTO:{}", userRolesDTO);
        UserRoles sourceUserRoles = new UserRoles();
        try {
            UserRoles userRoles = BeanUtil.copyProperties(userRolesDTO, sourceUserRoles);
    ...
    public Object update(@PathVariable("id") Long id, @RequestBody UserRolesDTO userRolesDTO, HttpServletRequest request) {
