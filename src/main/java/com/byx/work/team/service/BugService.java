...
public interface BugService {
     ...
     */
    void saveBug(Bug bug) throws BizException;

    /**
     * 保存多条 Bug 数据。
     *
     * @param bugList 待保存的数据列表。
     * @throws BizException 保存失败异常。
     */
    void saveBugList(List<Bug> bugList) throws BizException;

    /**
     * 根据id更新 Bug，字段为null的选项会把数据库字段更新为null，即全部更新。
     *
     * @param bug 更新的目标数据。
     */
     ...
     */
    void updateBugSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteBug(Long id, Long userId) throws BizException;
     ...
     */
    void deleteBug(Long id) throws BizException;
     ...
     * @return 符合条件的一个 Bug。
     */
    BugDTO findOneBug(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合。
     */
    List<BugDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
