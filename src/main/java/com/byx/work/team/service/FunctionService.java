...
public interface FunctionService {
     ...
     * 保存一条 Function 数据。
     *
     * @param function 待保存的数据。
     * @throws BizException 保存失败异常。
     */
    void saveFunction(Function function) throws BizException;

    /**
     * 保存多条 Function 数据。
     *
     * @param functionList 待保存的数据列表。
     * @throws BizException 保存失败异常。
     */
    void saveFunctionList(List<Function> functionList) throws BizException;

    /**
     * 根据id更新 Function，字段为null的选项会把数据库字段更新为null，即全部更新。
     *
     * @param function 更新的目标数据。
     */
     ...
     */
    void updateFunctionSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteFunction(Long id, Long userId) throws BizException;
     ...
     */
    void deleteFunction(Long id) throws BizException;

    /**
     * 根据id查询一条 Function。
     *
     * @param id 数据唯一id。
     * @return 查询到的 Function 数据。
     */
    FunctionDTO findFunctionById(Long id);

    /**
     * 根据条件查询得到第一条 Function。
     *
     * @param params 查询条件
     * @return 符合条件的一个 Function。
     */
    FunctionDTO findOneFunction(Map<String, Object> params);
