...
import com.byx.work.team.dao.UserRoleDAO;
...
public class UserRoleServiceImpl implements UserRolesService {
    ...
    @Autowired
    public UserRoleServiceImpl(UserRoleDAO userRolesDAO) {
        this.userRolesDAO = userRolesDAO;
    }

    @Override
    public void saveUserRoles(@NonNull UserRole userRoles) throws BizException {
    ...
    public void saveUserRolesList(@NonNull List<UserRole> userRolesList) throws BizException {
    ...
    @Override
    public void updateUserRoles(@NonNull UserRole userRoles) {
    ...
    @Override
    public UserRoleDTO findUserRolesById(@NonNull Long id) {
        Map<String, Object> params = new HashMap<>(1);
        params.put("id", id);
        UserRole userRoles = userRolesDAO.selectOne(params);
    ...
    @Override
    public UserRoleDTO findOneUserRoles(Map<String, Object> params) {
    ...
    @Override
    public List<UserRoleDTO> find(Map<String, Object> params,
        ...
        params.put("pc", pc);
        params.put("scs", scs);
        List<UserRole> userRolesList = userRolesDAO.select(params);
