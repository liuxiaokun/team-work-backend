 ...
 * @since 2019/10/28
 */
public interface PermissionMenusService {
     ...
     */
    void savePermissionMenus(PermissionMenus permissionMenus) throws BizException;
     ...
     * @throws BizException 保存失败异常。
     */
    void savePermissionMenusList(List<PermissionMenus> permissionMenusList) throws BizException;
     ...
     */
    void updatePermissionMenus(PermissionMenus permissionMenus);
     ...
     */
    PermissionMenusDTO findPermissionMenusById(Long id);
     ...
     */
    PermissionMenusDTO findOnePermissionMenus(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合。
     */
    List<PermissionMenusDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
