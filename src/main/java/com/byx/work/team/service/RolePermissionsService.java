...
public interface RolePermissionsService {
     ...
     */
    void updateRolePermissionsSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);

    /**
     * 根据id逻辑删除一条 RolePermissions。
     *
     * @param id 数据id。
     * @param userId 删除人的id。
     * @throws BizException 逻辑删除异常。
     */
    void logicDeleteRolePermissions(Long id, Long userId) throws BizException;

    /**
     * 根据id物理删除一条 RolePermissions。
     *
     * @param id 数据唯一id。
     * @throws BizException 物理删除异常。
     */
    void deleteRolePermissions(Long id) throws BizException;

    /**
     * 根据id查询一条 RolePermissions。
     *
     * @param id 数据唯一id。
