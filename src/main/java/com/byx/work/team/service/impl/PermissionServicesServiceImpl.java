...
import com.byx.work.team.dao.PermissionServicesDAO;
...
@Service
@Slf4j
public class PermissionServicesServiceImpl implements PermissionServicesService {

    private final PermissionServicesDAO permissionServicesDAO;

    @Autowired
    public PermissionServicesServiceImpl(PermissionServicesDAO permissionServicesDAO) {
        this.permissionServicesDAO = permissionServicesDAO;
    }

    @Override
    public void savePermissionServices(@NonNull PermissionServices permissionServices) throws BizException {
    ...
    public void savePermissionServicesList(@NonNull List<PermissionServices> permissionServicesList) throws BizException {
    ...
    @Override
    public void updatePermissionServices(@NonNull PermissionServices permissionServices) {
    ...
    @Override
    public PermissionServicesDTO findPermissionServicesById(@NonNull Long id) {
        Map<String, Object> params = new HashMap<>(1);
        params.put("id", id);
        PermissionServices permissionServices = permissionServicesDAO.selectOne(params);
        PermissionServicesDTO permissionServicesDTO = new PermissionServicesDTO();
    ...
    @Override
    public PermissionServicesDTO findOnePermissionServices(Map<String, Object> params) {
    ...
    @Override
    public List<PermissionServicesDTO> find(Map<String, Object> params,
        ...
        params.put("pc", pc);
        params.put("scs", scs);
        List<PermissionServices> permissionServicesList = permissionServicesDAO.select(params);
        List<PermissionServicesDTO> resultList = new ArrayList<>();
