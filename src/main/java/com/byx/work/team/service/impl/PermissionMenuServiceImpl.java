...
public class PermissionMenuServiceImpl implements PermissionMenuService {
    ...
    private final PermissionMenuDAO permissionMenusDAO;

    @Autowired
    public PermissionMenuServiceImpl(PermissionMenuDAO permissionMenusDAO) {
        this.permissionMenusDAO = permissionMenusDAO;
    }

    @Override
    public void savePermissionMenus(@NonNull PermissionMenu permissionMenus) throws BizException {
    ...
    public void savePermissionMenusList(@NonNull List<PermissionMenu> permissionMenusList) throws BizException {
    ...
    @Override
    public void updatePermissionMenus(@NonNull PermissionMenu permissionMenus) {
    ...
    @Override
    public PermissionMenuDTO findPermissionMenusById(@NonNull Long id) {
        Map<String, Object> params = new HashMap<>(1);
        params.put("id", id);
        PermissionMenu permissionMenus = permissionMenusDAO.selectOne(params);
        PermissionMenuDTO permissionMenusDTO = new PermissionMenuDTO();
    ...
    @Override
    public PermissionMenuDTO findOnePermissionMenus(Map<String, Object> params) {
    ...
    @Override
    public List<PermissionMenuDTO> find(Map<String, Object> params,
        ...
        params.put("pc", pc);
        params.put("scs", scs);
        List<PermissionMenu> permissionMenusList = permissionMenusDAO.select(params);
        List<PermissionMenuDTO> resultList = new ArrayList<>();
