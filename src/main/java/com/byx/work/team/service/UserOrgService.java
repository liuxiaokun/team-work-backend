...
public interface UserOrgService {
     ...
     * 保存一条 UserOrg 数据。
     *
     * @param userOrg 待保存的数据。
     * @throws BizException 保存失败异常。
     */
    void saveUserOrg(UserOrg userOrg) throws BizException;

    /**
     * 保存多条 UserOrg 数据。
     *
     * @param userOrgList 待保存的数据列表。
     * @throws BizException 保存失败异常。
     */
    void saveUserOrgList(List<UserOrg> userOrgList) throws BizException;

    /**
     * 根据id更新 UserOrg，字段为null的选项会把数据库字段更新为null，即全部更新。
     *
     * @param userOrg 更新的目标数据。
     */
     ...
     */
    void updateUserOrgSelective(Map<String, Object> dataMap, Map<String, Object> conditionMap);
     ...
     */
    void logicDeleteUserOrg(Long id, Long userId) throws BizException;
     ...
     */
    void deleteUserOrg(Long id) throws BizException;

    /**
     * 根据id查询一条 UserOrg。
     *
     * @param id 数据唯一id。
     * @return 查询到的 UserOrg 数据。
     */
    UserOrgDTO findUserOrgById(Long id);

    /**
     * 根据条件查询得到第一条 UserOrg。
     *
     * @param params 查询条件
     * @return 符合条件的一个 UserOrg。
     */
    UserOrgDTO findOneUserOrg(Map<String, Object> params);
     ...
     * @return 查询结果的数据集合。
     */
    List<UserOrgDTO> find(Map<String, Object> params, Vector<SortingContext> scs, PagingContext pc);
