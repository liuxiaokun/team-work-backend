...
import com.byx.work.team.dao.RolePermissionDAO;
...
@Service
@Slf4j
public class RolePermissionServiceImpl implements RolePermissionsService {

    private final RolePermissionDAO rolePermissionsDAO;

    @Autowired
    public RolePermissionServiceImpl(RolePermissionDAO rolePermissionsDAO) {
        this.rolePermissionsDAO = rolePermissionsDAO;
    }

    @Override
    public void saveRolePermissions(@NonNull RolePermission rolePermissions) throws BizException {
    ...
    public void saveRolePermissionsList(@NonNull List<RolePermission> rolePermissionsList) throws BizException {
    ...
    @Override
    public void updateRolePermissions(@NonNull RolePermission rolePermissions) {
    ...
    @Override
    public RolePermissionDTO findRolePermissionsById(@NonNull Long id) {
        Map<String, Object> params = new HashMap<>(1);
        params.put("id", id);
        RolePermission rolePermissions = rolePermissionsDAO.selectOne(params);
        RolePermissionDTO rolePermissionsDTO = new RolePermissionDTO();
    ...
    @Override
    public RolePermissionDTO findOneRolePermissions(Map<String, Object> params) {
    ...
    @Override
    public List<RolePermissionDTO> find(Map<String, Object> params,
        ...
        params.put("pc", pc);
        params.put("scs", scs);
        List<RolePermission> rolePermissionsList = rolePermissionsDAO.select(params);
